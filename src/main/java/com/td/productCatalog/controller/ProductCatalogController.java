...
import com.td.productCatalog.annotations.ValidEmailHeader;
...
public class ProductCatalogController implements ProductsApi {
    ...
    @GetMapping("/products")
    public ResponseEntity<List<Product>> getAllProducts(@ValidEmailHeader @RequestHeader("x-td-email") String emailId ) {
        System.out.println("request came to get all products"+ emailId);
